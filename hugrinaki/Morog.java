...
public class Morog extends JFrame 
{
    ...
    private String[] sizeOptions = {"Small(Tk.250)", "Medium(Tk.450)", "Large(Tk.800)"};
	...
	Morog()
	{
		...
		name =new JLabel("Morog Polao");
		buy =new JButton("Buy");
		text1=new JLabel("Chicken,Polao Rice,Egg");
		...
		JLabel pizza1 = new JLabel(new ImageIcon("morogpolao.jpg"));
