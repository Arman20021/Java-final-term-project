...
public class Teheri extends JFrame 
{
    ...
    private String[] sizeOptions = {"Small(Tk.220)", "Medium(Tk.400)", "Large(Tk.700)"};
	...
	Teheri()
	{
		...
		name =new JLabel("Teheri");
		buy =new JButton("Buy");
		text1=new JLabel("Beef,Rice,Egg");
		...
		JLabel pizza1 = new JLabel(new ImageIcon("Teherii.jpg"));
