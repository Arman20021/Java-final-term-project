...
public class Pizza3 extends JFrame 
{
    ...
    private String[] sizeOptions = {"Small(Tk.500)", "Medium(Tk.800)", "Large(Tk.1100)"};
	...
	Pizza3()
	{
		...
		name =new JLabel("Pepporoni Pizza");
		buy =new JButton("Buy");
		text1=new JLabel("Topped With Pepporoni,Capsicum,Italian Sauce,Cheese.");
		...
		JLabel pizza1 = new JLabel(new ImageIcon("pizza3.jpg"));
		...
		toppings[0] = new JCheckBox("Pepporoni");
