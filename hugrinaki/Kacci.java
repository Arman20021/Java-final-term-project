...
public class Kacci extends JFrame 
{
	...
	private String[] sizeOptions = {"Small(Tk.400)", "Medium(Tk.700)", "Large(Tk.1000)"};
	...
	Kacci()
	{
		...
		name =new JLabel("Mutton Kacci");
		buy =new JButton("Buy");
		text1=new JLabel("Mutton,Basmoti Rice,Potato");
		text2=new JLabel("Select Your Variant : ");
		text3=new JLabel("Select Your Salad : ");
		icon = new ImageIcon("photos/icon2.png");
		...
		JLabel piz1 = new JLabel(new ImageIcon("biryani1back.jpg"));
        JLabel pizza1 = new JLabel(new ImageIcon("biryani1m.jpg"));
		...
		text3.setBounds(500, 80, 300, 300);
		...
		toppings[0] = new JCheckBox("Cucumber");
		toppings[1] = new JCheckBox("Tomato");
		toppings[2] = new JCheckBox("Carrot");
		toppings[3] = new JCheckBox("Mix");
		...
		for (JCheckBox topping : toppings) {
			topping.addItemListener(new ItemListener() {
				...
				public void itemStateChanged(ItemEvent e) {
					// Handle checkbox state change events here
				}
			});
		}
