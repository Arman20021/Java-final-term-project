...
public class Pizza1 extends JFrame 
{
	...
	Pizza1()
	{
		...
		toppings[0] = new JCheckBox("Tomatoes");
		toppings[1] = new JCheckBox("Capsicum");
		toppings[2] = new JCheckBox("Cheese");
